...
class GUI:
    def __init__(self):
        ...
        self.send_button = tk.Button(self.root, text="Select & Send", font=("Helvetica", 16), bg="#007acc", fg="white", padx=10,
                                    pady=5, command=self.select_file)
        self.send_button.pack(padx=8, pady=8)
        # self.status_label = tk.Label(self.root, text="No file selected.", font=("Helvetica", 16))
